#!/bin/zsh
# ============================================================
# Spec Engineer Agent Shell Profile
# ============================================================
...
# 2. Source this file: source shell/spec_engineer_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-spec-engineer-aget}"
export AGET_ARCHETYPE="spec-engineer"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Spec_Engineer_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Spec_Engineer_VOCABULARY.md"
