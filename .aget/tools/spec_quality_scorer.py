...
Based on Law Insider benchmark: 70%+ overall quality for production-grade.
"""
...
class QualityScorer:
    ...
    def generate_report(self) -> str:
        ...
        if overall >= 70:
            assessment = "✅ PRODUCTION-GRADE (meets Law Insider benchmark)"
        elif overall >= 60:
        ...
        report.append("LAW INSIDER BENCHMARK COMPARISON:")
        report.append("  Law Insider: 30 capabilities, 70%+ quality")
