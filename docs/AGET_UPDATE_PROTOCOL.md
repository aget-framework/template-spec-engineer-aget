...
git pull https://github.com/aget-framework/aget-cli-agent-template.git main
...
# Review changes
curl -s https://raw.githubusercontent.com/aget-framework/aget-cli-agent-template/main/CHANGELOG.md
