...
**Actions**:
1. Go to https://github.com/aget-framework/aget-cli-agent-template/releases
...
```bash
cd /tmp
git clone https://github.com/aget-framework/aget-cli-agent-template.git test-v21
cd test-v21
